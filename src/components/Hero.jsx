...
export default function Hero({ onOpenModal }) {
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center text-center px-6 pt-20">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-neon-cyan/10 via-[#050505] to-[#050505] -z-10"></div>
      ...
      <button 
        onClick={onOpenModal} 
        className="px-8 py-4 font-bold text-black bg-gradient-to-r from-cyan-400 to-lime-400 rounded-xl hover:scale-105 transition-transform cursor-pointer shadow-[0_0_40px_rgba(0,242,255,0.3)]"
      >
